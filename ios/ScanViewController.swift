...
extension ScanViewController: VideoCameraWrapperDelegate {
...
//     }
    ...
    func getMRZKeyValue() -> [String: String] {
        ...
        if let strline: String =  shareScanningListing["lines"] as? String {
            self.lines = strline
        }
        if let strpassportType: String =  shareScanningListing["passportType"] as? String  {
            self.passportType = strpassportType
        }
        if let stRetval: String = shareScanningListing["retval"] as? String   {
            self.retval = Int(stRetval) ?? 0
        }
        if let strcountry: String =  shareScanningListing["country"] as? String {
            self.country = strcountry
        }
        if let strsurName: String = shareScanningListing["surName"] as? String {
            self.surName = strsurName
        }
        if let strgivenNames: String =  shareScanningListing["givenNames"] as? String  {
            self.givenNames = strgivenNames
        }
        if let strpassportNumber: String = shareScanningListing["passportNumber"] as? String   {
        ...
        if let strpassportNumberChecksum: String = shareScanningListing["passportNumberChecksum"] as? String {
            self.passportNumberChecksum = strpassportNumberChecksum
        }
        if let stcorrectPassportChecksum: String = shareScanningListing["correctPassportChecksum"] as? String{
            self.correctPassportChecksum = stcorrectPassportChecksum
        }
        if let strnationality: String =  shareScanningListing["nationality"] as? String  {
            self.nationality = strnationality
        }
        if let strbirth: String = shareScanningListing["birth"] as? String  {
            self.birth = strbirth
        }
        if let strbirthChecksum: String = shareScanningListing["BirthChecksum"] as? String{
            self.birthChecksum = strbirthChecksum
        }
        if let stcorrectBirthChecksum: String = shareScanningListing["correctBirthChecksum"] as? String{
            self.correctBirthChecksum = stcorrectBirthChecksum
        }
        if let strsex: String =  shareScanningListing["sex"] as? String {
            self.sex = strsex
        }
        if let strexpirationDate: String = shareScanningListing["expirationDate"] as? String {
            self.expirationDate = strexpirationDate
        }
        
        if let strexpirationDateChecksum: String = shareScanningListing["expirationDateChecksum"] as? String  {
            self.expirationDateChecksum = strexpirationDateChecksum
        }
        if let stcorrectExpirationChecksum: String = shareScanningListing["correctExpirationChecksum"] as? String{
            self.correctExpirationChecksum = stcorrectExpirationChecksum
        }
        if let strpersonalNumber: String = shareScanningListing["personalNumber"] as? String{
            self.personalNumber = strpersonalNumber
        }
        if let strpersonalNumber2: String = shareScanningListing["personalNumber2"] as? String{
            self.personalNumber2 = strpersonalNumber2
        }
        if let strpersonalNumberChecksum: String = shareScanningListing["personalNumberChecksum"] as? String {
            self.personalNumberChecksum = strpersonalNumberChecksum
        }
        if let stcorrectPersonalChecksum: String = shareScanningListing["correctPersonalChecksum"] as? String{
            self.correctPersonalChecksum = stcorrectPersonalChecksum
        }
        if let strsecondRowChecksum: String = shareScanningListing["secondRowChecksum"] as? String {
            self.secondRowChecksum = strsecondRowChecksum
        }
        if let stcorrectSecondrowChecksum: String = shareScanningListing["correctSecondrowChecksum"] as? String{
            self.correctSecondrowChecksum = stcorrectSecondrowChecksum
        }
        if let strplaceOfBirth: String = shareScanningListing["placeOfBirth"] as? String{
            self.placeOfBirth = strplaceOfBirth
        }
        if let strplaceOfIssue: String = shareScanningListing["placeOfIssue"] as? String {
            self.placeOfIssue = strplaceOfIssue
        }
        
        if let strissuedate: String = shareScanningListing["issuedate"] as? String {
            self.issuedate = strissuedate
        }
        
        if let strdepartmentNumber: String = shareScanningListing["departmentNumber"] as? String {
        ...
        for index in 0..<23{
            ...
            case 6:
                if correctPassportChecksum != ""{
                    ...
                    arrDocumentData.append(dict)
                    mrzData["Correct Document Check No."] = correctPassportChecksum
                }
                break
            ...
            case 10:
                if birth != "" {
                    ...
                    if birthDate != "" && birthDate != nil{
                        ...
                        arrDocumentData.append(dict)
                        mrzData["Date of Birth"] = birthDate
                    }
                }
                break
            case 11:
            ...
            case 13:
                if expirationDate != "" {
                    ...
                    if expiryDate != "" && expiryDate != nil{
                        ...
                        arrDocumentData.append(dict)
                        mrzData["Date of Expiry"] = expiryDate
                    }
                }
                break
            case 14:
                if expirationDateChecksum != ""{
                    ...
                    arrDocumentData.append(dict)
                    mrzData["Expiration Check No."] = expirationDateChecksum
                }
                break
            case 15:
            ...
            case 16:
                if personalNumber != ""{
                    ...
                    arrDocumentData.append(dict)
                    mrzData["Other ID"] = personalNumber
                }
                break
            case 17:
                if personalNumber2 != ""{
                    ...
                    arrDocumentData.append(dict)
                    mrzData["Other ID 2"] = personalNumber2
                }
                break
            ...
            case 18:
                if personalNumberChecksum != ""{
                    ...
                    arrDocumentData.append(dict)
                    mrzData["Other ID Check No."] = personalNumberChecksum
                }
                break
            case 19:
